...
const TopTierBySalary = ({ dataTopTier, dataSeason }: Props) => {
  const [selectedSalary, setSelectedSalary] = useState<any>("5");
      ...
      <Dropdown showArrow classNames={{ content: "p-0 rounded-none" }}>
        ...
        >
          <DropdownSection
            ...
            classNames={{
              group: [
                "flex flex-row w-[360px] flex-wrap border-none border-t border-l border-[#c0c0c0]",
              ],
            }}
          >
            {Object.keys(dataTopTier)?.map((salary: any) => (
              <DropdownItem
